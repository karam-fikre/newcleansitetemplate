jQuery(function($){
    ...
    var Formoid = (function(){
        ...
        Form.prototype.send = function(data, beforeStart){
            ...
            Email.send({
                Host : "send.one.com",
                Username : "info@ndstad.se",
                Password : "Samia123Dayf321",
                To : 'info@ndstad.se',
                From : 'info@ndstad.se',
                Subject : "Boka Online",
                Body :data[8][1] + "<br/> <br/>  <strong> "
                +"Namn: " + data[1][1] + "<br/>"
                +"Personnummer: " + data[2][1] + "<br/>"
                +"Adress: " + data[3][1] +" " + data[4][1] + "<br/>"
                +"Städyta: " + data[5][1] + "<br/>"
                +"Telefon: " + data[6][1] + "<br/>"
                +"E-post: " + data[7][1] +"</strong>"
            }).then(
              message => defer.resolve(message)
            );
        /*    $ajax(API_URL, {
                type : 'POST',
                data : JSON.stringify({
